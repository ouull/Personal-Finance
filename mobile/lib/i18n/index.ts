...
const translations = {
  id: {
    ...
    manageSubscriptions: 'Kelola pembayaran aktif Anda',
    ...
    shopping: 'Belanja',
    entertainment: 'Hiburan',
    digital_and_subscriptions: 'Digital & Pembayaran',
    personal: 'Personal',
