...
export async function DELETE(
  ...
  try {
    ...
    if (error.name === "CategoryError" && error.code === "SYSTEM_CATEGORY_DELETION_FORBIDDEN") {
      return NextResponse.json({ success: false, error: "Cannot delete system category" }, { status: 403 })
    }
