...
export async function POST(req: Request) {
  ...
  try {
    ...
    const { accountId, categoryId, name, type, amount, billingCycle, nextDueDate, reminderDays, notes } = parsed.data
    ...
    if (error.message === "Unauthorized account" || error.message === "Unauthorized category") {
