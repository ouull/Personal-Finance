...
export async function POST(req: Request) {
  try {
    ...
    if (session.revokedAt) {
      ...
      return errorResponse("COMPROMISED_SESSION", "Session compromised. All sessions revoked.", 401)
    }
    ...
    const deviceInfo = req.headers.get("user-agent") || session.deviceInfo || "Unknown Device"
