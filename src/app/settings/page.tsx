...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-8 pb-10">
      <FadeIn delay={0.1}>
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-200/50 pb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900 pb-1">{t.settings.title}</h1>
      ...
      <FadeIn delay={0.2}>
        <SettingsPanel initialLanguage={language} t={{ ...t.settings, ...t.common }} />
      </FadeIn>
    </div>
  )
}
