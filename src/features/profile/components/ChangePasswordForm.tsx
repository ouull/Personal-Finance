    ...
    if (result.success) {
      ...
      toast.error(
        result.error === "Incorrect current password"
          ? translations.incorrectPassword || "Incorrect current password"
          : translations.error || "Failed to change password",
      );
    }
  }
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="confirmPassword">
          {translations.confirmPassword || "Confirm New Password"}
        </Label>
        <Input
          id="confirmPassword"
          type="password"
