    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the current market value of this asset to reflect unrealized
            gains or losses.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                setValue("currentValue", rawValue ? Number(rawValue) : 0, {
                  shouldValidate: true,
                });
              }}
            />
